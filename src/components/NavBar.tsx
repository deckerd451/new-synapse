...
/**
 * NavBar renders the top navigation bar for the application.  It includes
 * links to the dashboard and search tabs, a theme toggle, and a logout
 * button.  On smaller screens the navigation collapses into a mobile menu.
 */
export default function NavBar() {
  ...
  // Restore persisted theme setting on mount
  useEffect(() => {
  ...
  return (
    <nav className="w-full bg-gray-900 text-white shadow-md sticky top-0 z-50">
      ...
      {/* Mobile Dropdown */}
      {isMobileMenuOpen && (
        <div className="md:hidden bg-gray-800 px-4 pb-3 space-y-3">
          <button
            onClick={() => {
